...
namespace CommunicationLibrary;
    ...
    /// </summary>
public class InterProcessDataSource : ISensorDataSource<string>
{
    ...
    public InterProcessDataSource(string pipeName)
    {
        _pipeName = pipeName;
    }
    ...
    private async Task ListenAsync(CancellationToken token)
    {
        ...
        {
            await Console.Error.WriteLineAsync($"[NamedPipeSensorClient] Error: {ex.Message}");
        }
    }
